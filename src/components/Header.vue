...
<template>
  <header
    class="w-full border-2 border-red-500 h-[100px] px-[30px] py-[22px] flex items-center justify-between fixed bg-white01 z-10"
  >
    <!-- 왼쪽 영역(로고 / 네비게이션) -->
    ...
    <div>
      ...
      >
        <img :src="headsetIcon" alt="헤드셋 아이콘" class="w-[20px] h-[20px]" />
      </div>
    </div>

    <!-- 오른쪽 영역(검색 / 유저정보 / 테마) -->
    <div class="flex items-center border border-red-500 gap-[30px]">
      <!-- 검색 -->
